...
This file has two modifications. The first is a dupe solution released by [Trayne01](https://www.elitepvpers.com/forum/shaiya-pserver-guides-releases/3798719-release-episode-5-4-packet-based-dupe-fix.html). It requires a modified `[dbo].[usp_Save_Char_Info_E]` procedure, which can be found in the in the `sql` directory. The second modification calls `DBCharacter::ReloadPoint` to get the user's cash points.
