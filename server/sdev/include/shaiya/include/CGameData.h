...
namespace shaiya
{
    ...
    struct CGameData
    {
        ...
        struct KCStatus
        {
            ...
            UINT32 physicalHitRate;   //0x50
            UINT32 meleeDefense;      //0x54
            UINT32 rangeDefense;      //0x58
            UINT32 magicDefense;      //0x5C
            UINT32 meleeEvasionRate;  //0x60
            UINT32 rangeEvasionRate;  //0x64
